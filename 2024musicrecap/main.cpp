...
int main() {
    ...
    cout << "Enter your top 5 favorite artists and rank them from 1 to 5 (1 = most favorite, 5 = least favorite):" << endl;
    ...
    // Prompt user to input their least favorite artist
        cout << "Enter your favorite album from your favorite artist: " << endl;
        cin >> favoriteAlbum;
